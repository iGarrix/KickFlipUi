	...
	return (
		<div className="border-2 border-dark/80 font-spacemono">
			...
			<aside className="flex p-[1rem] items-center gap-[2rem] pr-[2rem]">
				...
				<div className="grow">
					<h3 className="text-3xl font-semibold uppercase">{props.title}</h3>
					...
					<div className="flex items-start gap-[1rem] font-semibold text-sm">
						<button className="text-blue-500 transition-all hover:text-indigo-600">
							more details
						</button>
						<button className="text-blue-500 transition-all hover:text-indigo-600">
							add to cart
				...
				<div className="flex flex-col items-start whitespace-nowrap">
					...
					<h3 className="font-semibold">
						Size: <span className="uppercase">Any size</span>
					</h3>
					<p className="font-semibold">Available: {props.quantity}</p>
				</div>
			</aside>
		</div>
	);
