import { axiosHttp } from '@/lib/axios/axios.accessor';
import {
	GetPositionsDto,
	IPosition,
	PositionControllerPaths,
} from './positions.types';
import { BineResponse } from '@/lib/api_requests/common.fetches';
import { AxiosResponse } from 'axios';
import { setDelayAsync } from '@/lib/api_requests/delay';
